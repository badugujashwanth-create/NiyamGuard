...
|---|---|---|
| `$env:PYTEST_DISABLE_PLUGIN_AUTOLOAD="1"; python -m pytest backend/app/tests -q` | Pass | 268 collected tests execute successfully; the host's injected optional pytest plugins are excluded from this clean-environment gate. |
