...
| Fresh Alembic migration and normalized seed/load round trip | Pass | SQLite migrations through `20260807_0009`, readiness, review/publication audit row counts, and candidate evidence columns verified locally; PostgreSQL remains a CI/deployment gate |
