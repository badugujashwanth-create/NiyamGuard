...
Check the browser or terminal error first, then verify the documented environment variables and dependent services. External government, payment, identity, and notification systems are mocked or sandboxed; optional Ollama quality depends on local setup.
