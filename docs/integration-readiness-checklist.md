...
| Virtual Certificate Authority | `service_portal_service` | `/api/certificates/*`, `/api/certificates/verify/*` | `/portal`, `/verify-certificate` | Yes | `service_application_approved` | Mock | No official signing authority |
