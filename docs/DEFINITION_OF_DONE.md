...
- [x] Backend suite passes: 235 tests.
- [x] Frontend suite passes: 60 tests.
- [x] Frontend production build passes.
- [x] Production dependency and secret checks are included in CI.
- [x] The recruiter walkthrough runs the real synthetic simulation.
- [x] The accepted video is longer than three minutes and includes narration and captions.
- [x] Video metadata, hash, thumbnail, and reviewed evidence frames are stored with the release.
