...
@router.get("/{system_id}", dependencies=[Depends(require_roles("officer", "reviewer"))])
...
@router.post("/{system_id}/snapshots", dependencies=[Depends(require_roles("officer", "reviewer"))])
...
@router.get("/{system_id}/snapshots", dependencies=[Depends(require_roles("officer", "reviewer"))])
