...
class CircularDocumentRecord(Base):
    ...
    extraction_source: Mapped[str] = mapped_column(String(20), nullable=False, default="NATIVE_TEXT")
    ocr_used: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    ocr_storage_path: Mapped[str | None] = mapped_column(String(500), nullable=True)
    page_provenance: Mapped[list[dict[str, Any]]] = mapped_column(JSON, nullable=False, default=list)
